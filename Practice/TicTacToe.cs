...
namespace Practice
{
    ...
    public class TTTSolver2
    {
        ...
        public static List<string> GetComboWithOpp(List<string> pair, int[][] board, int opponent)
        {
            ...
            //if (combosWithOpponentAndTwoZero.Count() == 0)
            //    return combosWithOpponentAndOneZero;
            //else
            //    return combosWithOpponentAndTwoZero;
        ...
        public static int[] TurnMethod(int[][] board, int player)
        {
            ...
            //determine move based on player passed in
            //need to check all combos for:
            //winning, then check all for defense, then one spot, then none
            ...
            foreach (string[] combo in WinningCombos)
            {
                ...
                //int[] indexes = IdentifyPlay(playerIndexes, combo, board, opponent, opponentIndexes);
